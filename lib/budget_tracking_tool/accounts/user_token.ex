defmodule BudgetTrackingTool.Accounts.UserToken do
  use Ecto.Schema
  import Ecto.Query
  ...
  def build_session_token(user) do
    ...
    {token,
     %BudgetTrackingTool.Accounts.UserToken{
       token: token,
       context: "session",
       user_id: user.id
     }}
  ...
  def token_and_context_query(token, context) do
    from BudgetTrackingTool.Accounts.UserToken,
  ...
  def user_and_contexts_query(user, :all) do
    from t in BudgetTrackingTool.Accounts.UserToken,
